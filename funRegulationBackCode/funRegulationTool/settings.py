...
TARGET_PWMS_FILES_PATH = config('FUNREGULATION_TARGET_PWMS_FILES')
...
# EMAIL
EMAIL_USE_TLS = config('FUNREGULATION_EMAIL_USE_TLS')
EMAIL_HOST = config('FUNREGULATION_EMAIL_HOST')
